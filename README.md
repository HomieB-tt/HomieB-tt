...
║   ╚═╝╚══════╝╚═╝  ╚═╝╚══════╝╚═╝     ╚═╝╚═╝╚═╝  ╚═╝╚═╝  ╚═╝       ║
║                                                                     ║
║               C A R L T O N   —   M O B I L E   E N G .            ║
║                                                                     ║
╚═══════════════════════════════════════════════════════════════════╝
```

<code>root@homieb-tt:~$ whoami</code>
<br/>
...
|:----:|---------|-------------|-------|:------:|
| 💬 | **[Chatter](https://github.com/HomieB-tt/Chatter)** | Swift messaging project | Swift 5, iOS, CocoaPods, Firebase Auth/Firestore/Storage, Kingfisher | 🟢 |
| 🎵 | **[Chanteuse](https://github.com/HomieB-tt/Chanteuse)** | Offline-first music player for Android | Flutter 3.x, Dart, Provider, GoRouter, just_audio, audio_service, on_audio_query | 🟢 |
| 🏘️ | **[realestate-backend](https://github.com/HomieB-tt/realestate-backend)** | Real-estate listings & management API | Node.js, TypeScript, Express, Supabase, PostgreSQL, PostGIS, Docker, Vitest | 🟢 |
| 🏠 | **[hostelhop_admin](https://github.com/HomieB-tt/hostelhop_admin)** | Hostel management portal for custodians & owners | React 19, TypeScript, Vite, Tailwind CSS, Supabase, Framer Motion, Chart.js | 🟢 |
...
|:--------:|---------|------------|------|:--------:|
| 🔥 | **HostelHop Ecosystem** | React, Supabase, PostGIS | Scale to 10K+ users | 70% |
| ⚡ | **Mobile Engineering** | Flutter, Swift, Kotlin Compose | Production-grade apps | 85% |
...
| **Applied ML / Hugging Face** | HF Docs + Transformers | 🟠 25% | Fine-tuning, on-device inference |
| **Kubernetes (Advanced)** | Kodekloud + Practical Deployments | 🟡 50% | Helm, GitOps, Service Mesh |
...
<p>
  <code>&gt; open to collaborations on Mobile Engineering, Systems Design, and Backend Architecture_</code>
</p>
...
- ✅ Proven track record — multiple production apps with real users
- ✅ Architectural rigor — SOLID, Clean Code, Domain-Driven Design
- ✅ Security mindset — cybersecurity background, zero-trust approach
...
║ Tooling       : Git, Docker, Kubernetes, Ansible, Supabase  ║
...
> signal maintained. operator online.
```
